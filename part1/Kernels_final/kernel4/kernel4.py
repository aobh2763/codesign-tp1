...
#--------------------------------------------------------------------------
kernel_name="part1/Kernels_final/kernel4/kernel4.cl"
...
for TS in [4, 8, 16, 32]:
    for WIDTH in [1, 2, 4, 8]:
        ...
        program = cl.Program(context, kernelsource).build(
            options=[f"-DTS={TS}", f"-DWIDTH={WIDTH}"]
        )
        mmul = program.mmul
        ...
        print("for TS = ", TS, " and WIDTH = ", WIDTH, "\n")
        start_time = time()
        ...
        for i in range(COUNT):    
            ...
            try: 
                ...
                mmul(queue, (N//WIDTH,N), (TS//WIDTH,TS), N, N, N, d_a, d_b, d_c)
